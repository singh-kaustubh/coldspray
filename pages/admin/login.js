  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        toast.success(`Successfully signed in Admin ${response.name} `, {
          theme: "dark",
          ...
          <div className="w-full lg:w-5/12 px-4">
            ...
            <div className="flex justify-between flex-wrap mt-6">
              ...
              <Link href="/login" className="text-white">
                <span className="text-white cursor-pointer">User Login</span>
              </Link>
              <Link href="/admin/signup" className="text-white">
                <span className="text-white cursor-pointer">
                  Create new account
                </span>
              </Link>
