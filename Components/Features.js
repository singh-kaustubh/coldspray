        ...
        <div className="container px-5 py-20 mx-auto ">
          ...
          <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
            <div className="p-4 md:w-1/3 flex">
              <div className="w-12 h-12 inline-flex items-center justify-center rounded-full bg-red-100 text-red-900 mb-4 flex-shrink-0">
                <svg
                  fill="none"
                  stroke="currentColor"
                  strokeLinecap="round"
              ...
              <div className="flex-grow pl-6">
                <h2 className="text-white text-lg title-font font-medium mb-2">
                  Accountable for multiple divergent lengths!
                </h2>
                <p className="leading-relaxed text-base">
                  The model is capable of handeling different divergent lengths.
                </p>
